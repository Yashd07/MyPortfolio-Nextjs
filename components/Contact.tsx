  ...
  return (
    <div className="wrapper">
      <div className="max-w-5xl mx-auto flex flex-col gap-4 items-center justify-center">
        ...
        <a href="mailto:yashd1272@gmail.com">
      ...
      <div className="mt-8 flex items-center flex-wrap   gap-8 justify-center">
        <SocialLink title="Github" link="https://github.com/Yashd07" />
        <SocialLink title="Linkedin" link="https://www.linkedin.com/in/yashd0712/"/>
        <SocialLink title="Instagram" link="https://www.instagram.com/desaiyash_07/"/>
        <SocialLink title="Vercel" link="https://vercel.com/yashd07" />
      </div>
    </div>
  );
};
